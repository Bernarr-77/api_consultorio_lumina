      ...
      <aside className="sidebar">
        <div className="sidebar-brand">
          <div className="sidebar-logo">
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="var(--primary-dark)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <header className="admin-topbar">
          <div className="topbar-left">
            <h2 className="topbar-title">
              ...
              {location.pathname === '/providers' && 'Providers'}
              {location.pathname === '/services' && 'Serviços'}
              {location.pathname === '/appointments' && 'Agendamentos'}
